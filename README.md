...
# Java
Java is one of the most popular and widely used programming languages and platforms. It is fast, reliable and secure. Also, Java is an *object-oriented programming* language. Java is a *statically typed language*, meaning the type of data is predefined as part of the programing language, and all constants or variables are defined for a given program.
### Data Types:
They are basically of two types:
1. Primitive data types
1. Object data types

:sound:Primitive types consists of boolean, byte, char, short, int, long, float, and double. Object types consist of programmer created types.
### Variables in Java:
A variable is the name given to a memory location. It is the basic unit of storage in a program.
To declaring a variable, a programmer must include data type, variable name, and value.
For Eg. `int cost = 20;`
